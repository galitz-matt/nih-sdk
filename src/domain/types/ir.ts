export type PiName = {
   ...
   *   these are typically evaluated against the same PI.
   * - However, when combined with `anyName`, matches may span
   *   different PIs within the same project.
   */
  firstName?: string;
   ...
   *   these are typically evaluated against the same PI.
   * - When combined with `anyName`, matches may span multiple PIs.
   */
  lastName?: string;
