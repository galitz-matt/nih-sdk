import type { NameCriteria } from "../../infra/types/model/projects-input.model";

export class NameCriteriaBuilder {
  	private readonly nameCriteria: NameCriteria = {};

	/**
	 * Set any_name for a PI
	 * 
	 ...
	 */
  	anyName(value: string): this {
		this.nameCriteria.any_name = value;
    	return this;
  	}

	/**
     * Set the first name of the PI/PO.
     *
	...
	firstName(value: string): this {
		this.nameCriteria.first_name = value;
		return this;
	}

	/**
     * Set the last name of the PI/PO.
     *
     * - Supports partial (prefix/substring) matching.
	...
	lastName(value: string): this {
		this.nameCriteria.last_name = value;
		return this;
	}

    /**
     * Set the middle name of the PI/PO.
     *
	...
	middleName(value: string): this {
		this.nameCriteria.middle_name = value;
		return this;
	}
